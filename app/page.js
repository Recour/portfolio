    ...
    <div ref={scrollRef} className="px-6 bg-slate-900 lg:flex md:px-12 lg:px-48 lg:gap-3">
      ...
      <header className='lg:w-1/2 lg:sticky lg:top-0 lg:max-h-screen py-12 lg:py-24 lg:flex lg:flex-col lg:justify-between text-slate-400'>
        ...
        <div className='flex flex-row gap-3 mt-12 *:fill-slate-400 *:transition-all'>
          <a className='hover:fill-cyan-200' href='https://github.com/Recour' target='_blank'>
          ...
          <a className='hover:fill-cyan-200' href='https://www.linkedin.com/in/viktor-recour-784267167/' target='_blank'>
          ...
          <a className='hover:fill-cyan-200' href='https://www.threads.net/@viktorrecour' target='_blank'>
